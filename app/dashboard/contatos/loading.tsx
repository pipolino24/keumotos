export default function Loading() {
  return (
    <div className="min-h-screen bg-keu-gray-light">
      <div className="bg-white border-b border-keu-black/5 px-6 py-5 mb-6 flex items-center justify-between gap-3">
      ...
      <div className="px-6 space-y-3">
        {Array.from({ length: 6 }).map((_, i) => (
          ...
          >
            ...
            <div className="h-6 w-20 bg-amber-500/10 rounded animate-pulse" />
          </div>
        ))}
      </div>
    </div>
