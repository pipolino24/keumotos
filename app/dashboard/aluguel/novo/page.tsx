            ...
            {form.clienteMode === "existente" ? (
              <div>
                ...
                {loadingClientes ? (
                  ...
                  // Antes max-h-64 (256px) com overflow-y-auto fazia o scroll
                  // do mouse ficar preso na lista quando havia muitos clientes
                  // (>5). Aumentado pra max-h-[480px] + overscroll-contain pra
                  // o body voltar a rolar quando atinge o limite da lista.
              ...
              <div className="col-span-2 border-t border-keu-black/5 pt-4 mt-2">
                <div className="flex items-start gap-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  ...
                  <div className="text-xs text-amber-900 leading-relaxed">
                    <strong>Aluguel ≠ Plano Conquista.</strong> Aqui o cliente
                    aluga a moto por um período e devolve depois. Pra venda
                    parcelada com Plano Conquista (entrada + parcelas
                    quinzenais, moto fica com o cliente), use{" "}
                    <Link
