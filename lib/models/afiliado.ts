...
const AfiliadoSchema = new Schema<IAfiliadoDoc>(
  {
    ...
    valorMinimoVenda: { type: Number, min: 0 },
    comissaoMaxima: { type: Number, min: 0 },
    ...
    totalCliques: { type: Number, default: 0, min: 0 },
    totalIndicacoes: { type: Number, default: 0, min: 0 },
    totalVendas: { type: Number, default: 0, min: 0 },
    comissaoAcumulada: { type: Number, default: 0, min: 0 },
    comissaoPaga: { type: Number, default: 0, min: 0 },
    comissaoPendente: { type: Number, default: 0, min: 0 },
